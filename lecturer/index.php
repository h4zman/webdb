        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: var(--danger);height: auto;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php" style="width: 226px;height: 36px;"><i class="fas fa-user"></i><span>Profile</span></a><a class="nav-link" href="Class.php" style="width: 226px;height: 36px;"><i class="fa fa-reorder"></i><span>Class</span></a></li>
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   ...
                   <label>Please enter new link</label>
                   <input type="text" name="" id="link_update" class="form-control" />
                   <br />
                
               </div>
           </form> 
               <div class="modal-footer">
                   <input type="button"  value ="Submit"id="updatesubmit" class="btn btn-success" />
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
        ...
        function fetch_data()
    {
        ...
        $.ajax({
                        ...
                        url: 'assets/php/dashboard_next.php',
                        method :"POST",
                        sync: true,
                                        ...
                                        day = classes[i].Day;
                                                ...
                                                full_data [i+1]= '<div class="row">'+
                                                            ...
                                                            '<div class="card h-100"><a href="#"></a>'+
                                                                    ...
                                                                    '<h6 class="text-muted card-subtitle mb-2">Day: '+day+'</h6>'+
                                                            ...
                                                            '</div>'+
                                                                '<div class="col-md-5 offset-xl-0 mb-4">'+
                                                                    ...
                                                                    '<br><button type="button" class="btn btn-outline-info"id="next_edit_button'+i+'">Edit</button>'+
                                                                '</div>'+
                                                                '</div>'+
                                                            '</div>'+
                                                        '</div>'+
                                                ...
                                                document.getElementById("next_class").innerHTML = full_data.join(" ");
            ...
            url: 'assets/php/dashboard_today.php',
            method :"POST",
            sync: true,
            data :{student_id:student_id},
            cache: false,
        ...
        success: function(data) {
                    ...
                    var length = classes.length;
                      ...
                      console.log(length);
                        ...
                        var i;
                        var full_data=[];
                        full_data[0]= '<h1 class="my-4" id ="today">Today class</h1>';
                                    ...
                                    full_data [i+1]= '<div class="row">'+
                                                ...
                                                '</div>'+
                                                    '<div class="col-md-5 offset-xl-0 mb-4">'+
                                                        ...
                                                        '<h1 style="font-size: 23px;position: absolute;top: 13px;left: 13px;">Class Link:</h1><div class="group">'+      
                                                        '<a href="'+link+'" target="_blank">'+link+'</a>'+
                                                        '<br><button type="button" class="btn btn-outline-info"id="today_edit_button'+i+'">Edit</button>'+
                                                    '</div>'+
                                                    '</div>'+
                                                '</div>'+
                                            '</div>'+
      ...
      error: function(xhr, status, error) {
       ...
       $(document).on('click', ".btn", function(){
                    ...
                    var code=classes[index].Course_code;
                    console.log(code);
                     $('#updatemodal').modal('show');
                   
                     $('#updatesubmit').unbind().click(function(){
                       
                                                    var newfirstname= $("#first_name_update").val();
                                                    var newlink =$("#link_update").val();
                                                    ...
                                                    console.log(newlink);
                                                        ...
                                                        $('#form_create').trigger("reset");
                                                         ...
                                                         $.ajax({
                                                                  ...
                                                                  success: function(data) {
                                                                                          // alert(data);
                                                                                            console.log("data has been sent to php");
                                                                                            fetch_data();
                                                                                            },
                                                                 error: function(xhr, status, error) {
                                                                                               console.error(xhr);
